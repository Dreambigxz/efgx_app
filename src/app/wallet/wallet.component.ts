  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe(params => {
      ...
      if (this.directory==='deposit') {
        if (!this.awaitingDeposit||this.awaitingDeposit&&this.awaitingDeposit.transaction&&this.initCurrency.symbol==='$'||this.awaitingDeposit.transaction[0].generator==='awaiting_deposit_confirmation') {
          this.isLoadingContent = true
